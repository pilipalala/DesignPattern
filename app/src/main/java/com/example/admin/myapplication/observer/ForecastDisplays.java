...
public class ForecastDisplays implements Observer, DisplayElement {
    private final Observable weatherData;
    private float temp, humidity, pressure;

    public ForecastDisplays(Observable weatherData) {
    ...
    @Override
    public void display() {
        Log.e("display-->", "2-ForecastDisplays: " + "temp-->" + temp + "humidity-->" + humidity + "pressure-->" + pressure);
    }
